...
// import CharacterPreview3D from '@/components/CharacterPreview3D'; // Commented out
...
// Dynamically import CharacterPreview3D
const DynamicCharacterPreview3D = dynamic(() => import('@/components/CharacterPreview3D'), {
  ssr: false,
  loading: () => <div className="flex justify-center items-center h-96 bg-gray-800 rounded-lg"><p className="text-white">Loading 3D Preview...</p></div>,
});
